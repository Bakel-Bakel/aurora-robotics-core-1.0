...
def fk(theta1, theta2): #This function is used to define the positiion of the two links in space in respect to the angles between each-other and the ground level
    ...
    return (0, 0), (x1, y1), (x2, y2) #This line returns the position of the two links with respect to an origi (0,0)
...
ax = plt.subplot(111) #This specifies the amount of sub-plots in the main plot (111) specifies 1 by 1 sub-plot and in the first position compared to (559) which is basically a bunch of plots forming a  5 by 5 grid and the plot in question is in the 9th grid
